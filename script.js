...
const toolkitCta=(title='Want to improve your job search faster?')=>`<div class="cta-card"><h3>${title}</h3><p>Get ready-to-use templates, AI prompts, interview answers, and a 30-day job plan.</p><div class="actions"><a class="btn" href="https://payhip.com/b/X48ki" target="_blank" rel="noopener">Get ₹99 Starter Toolkit</a><a class="btn btn-outline" href="/#choose-toolkit">Get ₹199 Complete Toolkit</a></div></div>`;
