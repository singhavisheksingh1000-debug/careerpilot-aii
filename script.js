...
const toolkitCta=(title='Want to improve your job search faster?')=>`<div class="cta-card"><h3>${title}</h3><p>Get ready-to-use templates, AI prompts, interview answers, and a 30-day job plan.</p><div class="actions"><a class="btn payhip-buy-button" href="https://payhip.com/b/Grn2m" target="_blank" rel="noopener noreferrer">Get Instant Access</a><a class="btn btn-outline payhip-buy-button" href="https://payhip.com/b/mqZBY" target="_blank" rel="noopener noreferrer">Download Toolkit</a></div></div>`;
...
if(funnelPaths.includes(window.location.pathname)){
  ...
  if(main && !document.querySelector('[data-static-funnel-cta]')){
    ...
    section.innerHTML=`<div class="container"><div class="cta-card static-funnel-card"><h2>Want to improve your job search faster?</h2><p>Get ready-to-use templates, AI prompts, interview answers, and a 30-day job plan.</p><div class="actions"><a class="btn payhip-buy-button" href="https://payhip.com/b/Grn2m" target="_blank" rel="noopener noreferrer">Get Instant Access</a><a class="btn btn-outline payhip-buy-button" href="https://payhip.com/b/mqZBY" target="_blank" rel="noopener noreferrer">Download Toolkit</a></div></div></div>`;
